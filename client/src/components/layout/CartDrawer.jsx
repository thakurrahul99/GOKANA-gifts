                      ...
                      <div className="flex-1 flex flex-col justify-between">
                        <div>
                          <div className="flex items-start justify-between gap-2">
                            ...
                            <button onClick={() => removeItem(key)} aria-label={`Remove ${product.name} from cart`} className="text-muted hover:text-red-400 min-w-[44px] min-h-[44px] flex items-center justify-center -mr-2 -mt-2 transition-colors"><Trash2 size={16} /></button>
                          </div>
                        ...
                        <div className="flex items-center justify-between mt-3 pt-2 border-t border-border">
                          ...
                          <div className="text-right"><span className="block text-[10px] uppercase tracking-wider text-muted">Item Subtotal</span><span className="font-sans text-sm font-semibold text-accent">{formatPrice(product.price * qty)}</span></div>
                        </div>
                      </div>
                    </div>
                  ))}
