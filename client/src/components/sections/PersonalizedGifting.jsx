...
export function PersonalizedGifting() {
  return (
    <section id="personalisation" className="section-py bg-[#12100E] text-ivory overflow-hidden border-b border-[rgba(197,160,89,0.15)]" aria-labelledby="personalisation-heading">
      <div className="container-gokana">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          {/* Left — Visually Rich Calligraphy Keepsake Simulation */}
          <ScrollReveal direction="scale" className="relative">
            <div className="relative aspect-square max-w-md mx-auto bg-[#181512] rounded-[8px] p-8 md:p-12 border border-[rgba(197,160,89,0.3)] shadow-[0_12px_40px_rgba(0,0,0,0.7)] flex flex-col items-center justify-center text-center">
              {/* Subtle Gold Ornamental Stamp */}
              <div className="w-12 h-12 rounded-full border border-[rgba(197,160,89,0.4)] bg-[#1F1A16] flex items-center justify-center text-accent mb-6">
              ...
              <div className="pt-4 border-t border-[rgba(197,160,89,0.2)] w-full flex items-center justify-between text-xs text-[#A39A8E] font-sans">
              ...
              {/* Floating Tag */}
              <div className="absolute -top-3 -right-3 bg-[#1F1A16] border border-[rgba(197,160,89,0.4)] text-accent px-4 py-1.5 rounded-full text-[11px] font-semibold tracking-[0.14em] uppercase shadow-lg flex items-center gap-1.5">
          ...
          <div>
            ...
            <ScrollReveal delay={0.25}>
              <p className="font-sans text-sm md:text-base text-[#A39A8E] leading-relaxed mb-8 max-w-lg">
            ...
            <StaggerReveal className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8" stagger={0.06}>
              {personalizationOptions.map(({ icon: Icon, title, desc }) => (
                <motion.div
                  ...
                  className="p-4 rounded-[6px] bg-[#181512] border border-[rgba(197,160,89,0.2)] hover:border-[rgba(197,160,89,0.45)] transition-colors"
                >
                  ...
                  <p className="font-sans text-xs text-[#A39A8E] leading-relaxed">{desc}</p>
                </motion.div>
              ))}
            </StaggerReveal>
