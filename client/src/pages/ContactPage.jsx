...
export function ContactPage() {
  ...
  const inputClass =
    'w-full px-4 py-3.5 bg-[#12100E] border border-[rgba(197,160,89,0.25)] rounded-lg text-ivory text-sm placeholder:text-[#A39A8E]/50 focus:border-accent focus:ring-1 focus:ring-accent/30 outline-none transition-all';
      ...
      <div className="container-gokana py-12 sm:py-16">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14">
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="bg-[#181512] border border-[rgba(197,160,89,0.22)] rounded-2xl p-7 shadow-xl">
              <h2 className="font-serif text-2xl font-light text-ivory mb-2">Direct Contact</h2>
              <p className="font-sans text-xs text-[#A39A8E] mb-6 font-light leading-relaxed">
              ...
              <div className="space-y-5">
                ...
                <a
                  ...
                  className="flex items-start gap-4 p-4 rounded-xl bg-[#12100E] border border-[rgba(197,160,89,0.18)] hover:border-accent hover:bg-[#1A1613] transition-all group"
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between">
                      <span className="font-sans text-xs uppercase tracking-wider text-[#A39A8E] font-medium">WhatsApp Support</span>
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <span className="font-sans text-xs uppercase tracking-wider text-[#A39A8E] font-medium">Email Support</span>
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <span className="font-sans text-xs uppercase tracking-wider text-[#A39A8E] font-medium">Phone Support</span>
                    <p className="font-serif text-lg text-ivory group-hover:text-accent transition-colors mt-0.5">+91 99999 99999</p>
                  </div>
                </a>

                {/* Operating Hours */}
                <div className="flex items-start gap-4 p-4 rounded-xl bg-[#12100E] border border-[rgba(197,160,89,0.18)]">
                  ...
                  <div className="flex-1 min-w-0">
                    <span className="font-sans text-xs uppercase tracking-wider text-[#A39A8E] font-medium">Working Hours</span>
                    <p className="font-serif text-base text-ivory mt-0.5">Monday – Saturday: 9:00 AM – 8:00 PM IST</p>
                    <p className="text-[11px] text-[#A39A8E] mt-0.5">Orders placed on Sundays dispatched on Monday morning.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Corporate Highlight */}
            <div className="bg-[#181512] border border-[rgba(197,160,89,0.22)] rounded-2xl p-6 shadow-xl relative overflow-hidden">
              <div className="flex items-center gap-3 mb-3">
                <Building2 size={20} className="text-accent" />
                <h3 className="font-serif text-lg font-light text-ivory">Corporate & Bulk Orders</h3>
              </div>
              <p className="font-sans text-xs text-[#A39A8E] leading-relaxed font-light mb-4">
          ...
          <div className="lg:col-span-7">
            <div className="bg-[#181512] border border-[rgba(197,160,89,0.22)] rounded-2xl p-8 sm:p-10 shadow-2xl">
              <div className="mb-8">
              ...
              {submitted ? (
                <motion.div
                  ...
                  className="text-center py-16 px-6 bg-[#12100E] border border-accent/40 rounded-xl"
                >
                  ...
                  <p className="font-sans text-sm text-[#A39A8E] max-w-md mx-auto mb-6 leading-relaxed">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <p className="text-center font-sans text-[11px] text-[#A39A8E] pt-2 font-light">
