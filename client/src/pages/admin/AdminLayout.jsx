...
export function AdminLayout() {
  ...
  return (
    <div className="flex h-screen bg-[#12100E] font-sans text-ivory">
      <aside className={clsx('flex flex-col bg-[#181512] border-r border-[rgba(197,160,89,0.2)] transition-all duration-300 flex-shrink-0 shadow-xl', sidebarOpen ? 'w-60' : 'w-16')}>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <header className="bg-[#181512] border-b border-[rgba(197,160,89,0.2)] px-6 py-4 flex items-center gap-4 shadow-sm">
        ...
        <main className="flex-1 overflow-y-auto p-6 bg-[#12100E] text-ivory"><Outlet /></main>
      </div>
    </div>
  );
}
